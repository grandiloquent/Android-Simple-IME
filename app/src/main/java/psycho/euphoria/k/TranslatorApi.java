...
public class TranslatorApi {
    private static final Pattern mChinese = Pattern.compile("[\\u4e00-\\u9fa5]");

    public static String translate(String q) throws Exception {
        boolean isChinese = mChinese.matcher(q).find();
        String uri = createTranslationURI(q, isChinese ? "zh_CHS" : "en", isChinese ? "en" : "zh_CHS");
    ...
    private static String createTranslationURI(String query, String from, String to) throws URISyntaxException {
